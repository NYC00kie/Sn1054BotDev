  ...
  Sale.findOne({
    ...
    .then(docs => {
      if (docs.happygif == 0) {
        ...
        message.channel.send({
          files: ["./commands/cxgifs/happy.gif"]
        });
      }
    })
}
  ...
  Sale.findOne({
    ...
    .then(docs => {
      if (docs.klickgif == 0) {
        ...
        message.channel.send({
          files: ["./commands/cxgifs/klick.gif"]
        });
      }
    })
};
  ...
  Sale.findOne({
    ...
    .then(docs => {
      if (docs.pointgif == 0) {
        ...
        message.channel.send({
          files: ["./commands/cxgifs/point.gif"]
        });
      }
    })
}
  ...
  Sale.findOne({
    ...
    .then(docs => {
      if (docs.spockgif == 0) {
        ...
        message.channel.send({
          files: ["./commands/cxgifs/spock.gif"]
        });
      }
    })
}
  ...
  Sale.findOne({
    ...
    .then(docs => {
      if (docs.thumbsgif == 0) {
        ...
        message.channel.send({
          files: ["./commands/cxgifs/thumbs.gif"]
        });
      }
    })
}