...
exports.get_shophelp = (message) => {
  ...
  .addField("Allgemeine Leistungen","Nickname ändern:\n ``.changenick [neuer Nickname]`` - ändert deinen Nickname\n Kosten: 400 Noca-Coins")
  .addField("Emotes (Gif's)","Gifs, die man mit den jeweiligen Befehlen in den Chat beschwören kann.\n NICHT VERKAUFBAR!\n happy - 1000 Noca-Coins [``.happy``]\n sad - 1000 Noca-Coins [``.sad``]\n spock - 1000 Noca-Coins [``.spock``]\n thumbsup - 1000 Noca-Coins [``.thumbsup``]\n bye - 1000 Noca-Coins [``.bye``]\n point - 1000 Noca-Coins [``.point``]\n click - 1000 Noca-Coins [``.click``]")
  .addField("Rollen zum Kaufen","quasar = dunkel Orange (``.buyrole quasar``)\n Kaufen: 115'000 Noca-Coins Verkaufen: 109'250 Noca-Coins\npulsar = helles Hellblau (``.buyrole pulsar``)\n Kaufen: 95'000 Noca-Coins Verkaufen: 90'250 Noca-Coins\n schwarzes-loch = schwarz (``.buyrole schwarzes-loch``)\n Kaufen: 80'000 Noca-Coins Verkaufen: 76'000 Noca-Coins\n neutronen-stern = Hellblau (``.buyrole neutronen-stern``)\n Kaufen: 75'000 Noca-Coins Verkaufen: 71'250 Noca-Coins\n supernova = Weiß (``.buyrole supernova``)")
   .addField("Rollen zum Kaufen2","Kaufen: 50'000 Noca-Coins Verkaufen: 47'500‬ Noca-Coins\n roter-riese = Rot (``.buyrole roter-riese``)\n Kaufen: 25'000 Noca-Coins Verkaufen: 23'750 Noca-Coins\n hauptreihenstern = Gelb (``.buyrole hauptreihenstern``)\n Kaufen: 20'000 Noca-Coins Verkaufen: 19'000 Noca-Coins\n weißer-zwerg = superhelles Blau (``.buyrole weißer-zwerg``)\n Kaufen: 13'000 Noca-Coins Verkaufen: 12'350 Noca-Coins\n roter-zwerg = helles braun-rot (``.buyrole roter-zwerg``)\n Kaufen: 10'000 Noca-Coins Verkaufen: 9'500 Noca-Coins\n brauner-zwerg = Beige (``.buyrole brauner-zwerg``)\n Kaufen: 8'000 Noca-Coins Verkaufen: 7'600 Noca-Coins\n gaswolke = dunkelblau (``.buyrole gaswolke``)\n Kaufen: 5'000 Noca-Coins Verkaufen: 4'750 Noca-Coins\n Memes = Zugriff auf den Memes-Kanal (``.buyrole memes``)\n Kaufen: 50 Noca-Coins")
